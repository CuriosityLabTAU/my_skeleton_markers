...
namespace skeleton_tracker
{
	class SkeletonTracker
  {
    public:
      ...
      void init()
      {
        ...
        tracking_pub_ = n.advertise<std_msgs::String>("/tracking", rate); // goren
      }
	...
	std_msgs::String tracking_msg;
	  ...
	  if (UserGenerator.GetSkeletonCap().IsCalibrating(user))
	  {
		tracking_msg.data = "calibrating";
		tracking_pub_.publish(tracking_msg);
	  }
  ...
  private:
    ...
    ros::Publisher  tracking_pub_;    // goren
  };
